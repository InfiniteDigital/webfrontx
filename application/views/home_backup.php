...
if (!empty($tokenApiLotto) && $tokenApiLotto['status_login']) {
    echo " <script> window.open('" . $urlKeylotto . "/login-keylotto?token=" . $tokenApiLotto . "','_blank') </script>";
}
?>
...
<body class="d-flex flex-column h-100">
                                ...
                                <div class="btn -btn -btn-image-primary">
                                    ...
                                    <div class="-real-content-wrapper">
                                        <div class="-bg-img">
                                            ...
                                            <?php  } else { ?>
                                                <div class="-btn-text"><a href="game">ทางเข้าเล่น Game</a></div><a href="game"><img width="500" height="160" src="images/btn-primary-bg.png" class="image wp-image-719  attachment-full size-full" alt="" loading="lazy" style="max-width: 100%; height: auto;" srcset="images/btn-primary-bg.png 500w, images/btn-primary-bg.png 300w" sizes="(max-width: 500px) 100vw, 500px"></a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="js-content mx-auto text-center animated fadeInModal" data-animatable="fadeInModal" data-delay="1500">
                                            ...
                                            <div class="text-center d-flex flex-column">
                                                ...
                                                ?>
                                                    <div class="mb-3">
                                                        <div class="media m-auto d-inline-flex">
                                                            <img src="https://ufaplus-888.com/image/scb2.png" alt="bank-bay" width="50px" class="rounded-circle mr-3">
                                                ...
                                                ?>
                                                    <div class="mb-3">
                                                        <div class="media m-auto d-inline-flex">
                                                            <img src="https://ufaplus-888.com/image/ktb.png" alt="bank-bay" width="50px" class="rounded-circle mr-3">
                                                            <div class="media-body text-left d-flex flex-column">
                                                                <div class="d-flex flex-lg-column flex-row">
    ...
    <script>
        $(document).on('click', '#btn_promotion', function() {
            var id = $(this).attr("id-promotion");
            var type = $(this).attr("type-promotion");
            if (type == 1) {
        ...
        function onChangeSelectPromotion() {
            ...
            if (id == 0) {
                ...
                $.ajax({
                    url: "/apitopup/get_promotion_by_id/" + id,
                    method: 'post',
                    success: function(result) {
                        if (result.data.pro_type == 1) {
                            let pro_id = '<?php echo $u_pro['id'] ?>';
                            let money = '<?php echo $u_pro['money'] ?>';
                            htm = `<h4>รายละเอียดโปรโมชั่น</h4>
                                <img src="${result.data.img_name}" class="img-fluid d-lg-block d-none " alt="">
                                <textarea id="editor" rows="15" class="form-control" name="text_1">${result.data.text}</textarea>
                                <br>`;
                            if (pro_id == id) {
                                htm += `<h2 class="text-center" style="color:red;">คุณรับโปรโมชั่นนี้ไปแล้ว จำนวน <span> ${money} </span> บาท </h2>`;
                            } else {
                                htm += `<button id="btn_promotion" id-promotion="${result.data.id}" type-promotion="${result.data.pro_type}" type="submit" class="btn btn-primary btn-lg btn-block mt-5" data-disable-on-click="">รับโปรโมชั่น</button>`;
                            }
                            document.getElementById('promotion_detail_div').innerHTML = htm;
                        } else if (result.data.pro_type == 2) {
                            let pro_id = '<?php echo $u_pro_newDate['id'] ?>';
                            let money = '<?php echo $u_pro_newDate['money'] ?>';
                            htm = `<h4>รายละเอียดโปรโมชั่น</h4>
                                <img src="${result.data.img_name}" class="img-fluid d-lg-block d-none " alt="">
                                <textarea id="editor" rows="15" class="form-control" name="text_1">${result.data.text}</textarea>
                                <br>`;
                        ...
                        } else if (result.data.pro_type == 3) {
                            htm = `<h4>รายละเอียดโปรโมชั่น</h4>
                                <img src="${result.data.img_name}" class="img-fluid d-lg-block d-none " alt="">
                                <textarea id="editor" rows="15" class="form-control" name="text_1">${result.data.text}</textarea>
                                <br>`;
