...
<head>
	...
	<script src="https://www.google.com/recaptcha/api.js?render=<?= $seting['re_sitekey'] ?>"></script>
</head>
		...
		<div _ngcontent-qbu-c187="" id="app" style="min-height: calc(100% - 60px); overflow: hidden;">
			...
			<nav _ngcontent-qbu-c187="" id="sidebar" hidden="">
				...
				<div _ngcontent-qbu-c187="" class="sidebar-header">
					<div _ngcontent-qbu-c187="" class="align-center text-center"><img _ngcontent-qbu-c187="" src="<?= $theme_asset ?>/img/user-128.png" alt="หวยฮานอย" width="110" height="100" onerror="this.src='<?= $theme_asset ?>/img/user-128.png'" class="rounded-circle"><br _ngcontent-qbu-c187=""><span _ngcontent-qbu-c187="" class="username"></span><br _ngcontent-qbu-c187=""><i _ngcontent-qbu-c187="" class="fas fa-coins"></i><span _ngcontent-qbu-c187="" data-id="credit_balance" class="badge badge-pill badge-danger thb" style="margin-left: 5px;"> ฿</span></div>
				</div>
					...
					<div _ngcontent-qbu-c187="" class="container">
						<div _ngcontent-qbu-c187="" class="d-flex justify-content-between align-items-center">
							...
							<div _ngcontent-qbu-c187="" class="d-flex flex-row justify-content-between align-items-center">
								...
								<div _ngcontent-qbu-c187="" id="sidebarCollapse" class="mobile-view"><img _ngcontent-qbu-c187="" src="<?= $theme_asset ?>/img/user-128.png" alt="หวยฮานอย วันนี้ ออกอะไร" onerror="this.src='<?= $theme_asset ?>/img/user-128.png'" width="28" height="28" title="บัญชีผู้ใช้" class="rounded-circle ml-1"><i _ngcontent-qbu-c187="" class="fas fa-ellipsis-v" style="margin-left: 5px;"></i>
								</div>
								<div _ngcontent-qbu-c187="" class="dropdown pc-view ml-1">
									<div _ngcontent-qbu-c187="" id="menu-profile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" class="dropdown-toggle"><img _ngcontent-qbu-c187="" src="<?= $theme_asset ?>/img/user-128.png" alt="หวยฮานอย วันนี้ ออกอะไร" onerror="this.src='<?= $theme_asset ?>/img/user-128.png'" width="40" height="35" class="rounded-circle"><span _ngcontent-qbu-c187="" id="username" class="ml-1"></span></div>
			...
			<app-register _nghost-qbu-c180="" class="ng-star-inserted">
				<div _ngcontent-qbu-c180="" class="container">
					<section _ngcontent-qbu-c180="" id="contentbox" class="h-100 mb-5">
						<div _ngcontent-qbu-c180="" class="bg-theme-dark rounded px-3 py-2 mt-2">
						...
						<?php if (!empty($banner)) : ?>
							<div _ngcontent-qbu-c180="" class="main-banner-top my-2 pc-view">
								<img _ngcontent-qbu-c180="" src="<?= $banner[0]->img_name ?>" style="max-width: 100%; border-radius: 5px;">
							</div>
							<div _ngcontent-qbu-c180="" class="mobile-view d-flex flex-column my-2">
								<img _ngcontent-qbu-c180="" src="<?= $banner[0]->img_name ?>" style="max-width: 100%;">
							</div>
						<?php endif; ?>
									...
									<div _ngcontent-hbb-c133="" class="form-row" style="padding-right: 33px !important;
										...
										<div _ngcontent-hbb-c133="" class="col-12 col-sm-12 col-md-6" style="padding-right: 33px !important;
											...
											<div _ngcontent-hbb-c133="" class="border rounded mb-2">
												<select _ngcontent-hbb-c133="" id="bank_name" class="form-select form-select-sm mat-select selectpicker form-control ng-tns-c132-1 mat-select-empty" aria-label=".form-select-sm example">
													...
													<option value="ttb">ทหารไทย</option>
										...
										<div _ngcontent-hbb-c133="" class="col-12 col-sm-12 col-md-6 mb-1" style="padding-right: 33px !important;
											...
											<label _ngcontent-hbb-c133=""><i _ngcontent-hbb-c133="" class="fas fa-clipboard-check"></i>
												เลขที่บัญชี</label><input _ngcontent-hbb-c133="" type="text" id="acc" name="acc" placeholder="ระบุเฉพาะตัวเลข" maxlength="15" onchange="checkBankNew()" class="form-control bankinput ng-untouched ng-pristine ng-valid"><small _ngcontent-hbb-c133="" id="checkacc1"></small>
										</div>
										<div _ngcontent-hbb-c133="" class="col-12 col-sm-12 col-md-6" style="padding-right: 33px !important;
                                                padding-left: 22px !important;">
	...
	<script>
		$(document).ready(function() {
			grecaptcha.ready(function() {
				grecaptcha.execute('<?= $seting['re_sitekey'] ?>', {
					action: 'submit'
				}).then(function(token) {
					$('#ccress').val(token);
		...
		function checkBankNew() {
			...
			if (bank_name != 'truewallet') {
				...
				// $.ajax({
				// 	url: 'api/check_bank',
				// 	// url: 'https://la168.info/api/check_bank',
				// 	type: 'POST',
				// 	data: {
				// 		bank_name: bank_name,
				// 		bank_number: acc,
				...
				// 	}
				// });				
				document.getElementById("name").placeholder = 'ใส่ชื่อบัญชี';
