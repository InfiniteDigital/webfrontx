...
<head>
	...
	<meta property="og:title" content="หน้าหลัก - ufaplus-888">
	...
	<meta property="og:site_name" content="ufaplus-888">
...
<body class="d-flex flex-column h-100">
	...
	<div class="x-web-list-sidebar">
		<div class="-inner-wrapper">
			...
			<div class="pl-2 pt-4 pb-3 logosidebar">
				<a href="#" class="custom-logo-link" aria-current="page"><img width="640" height="306" src="images/logo.png" class="custom-logo" alt="ufaplus-888" srcset="images/logo.png 640w, images/logo.png 300w" sizes="(max-width: 640px) 100vw, 640px"></a>
			</div>
			<hr class="-hr">
		</div>
		...
		<div class="container align-items-center position-relative">
			<div id="headerBrand">
				<div class="navbar-brand navlogoimg">
					<a href="#" class="custom-logo-link" aria-current="page"><img width="640" height="306" src="images/logo.png" class="custom-logo" alt="ufaplus-888" srcset="images/logo.png 640w, images/batch_Logo3-copy-300x143.png 300w" sizes="(max-width: 640px) 100vw, 640px"></a>
				</div>
			</div>
			<div id="headerContent">
				<div class="navbar-nav">
					...
					<?php } else {  ?>
						<div class="d-flex">
							<span class="btn btn-primary mt-lg-3" style="margin-right: 0.3rem !important; background-image: linear-gradient(360deg, #0021ec, #121212 51.68%, #313131), linear-gradient(90deg, #9c6727, #fdf6ae 31.53%, #bd8d42 64.87%, #fdf6ae) !important;">
								<div class="-text-container">
						...
						<a href="#" data-toggle="modal" data-target="#modal-deposit">
							<button class="btn btn-primary mt-lg-3" style="margin-right: 0.3rem !important;background-image: linear-gradient(360deg, #06ff5c, #121212 51.68%, #313131), linear-gradient(90deg, #9c6727, #fdf6ae 31.53%, #bd8d42 64.87%, #fdf6ae) !important;" id="deposit_pc">
								<div class="-text-container">
						...
						<a href="#" data-toggle="modal" data-target="#modal-withdraw">
							<button class="btn btn-primary mt-lg-3" style="margin-right: 0.3rem !important; background-image: linear-gradient(360deg, #ff0009, #121212 51.68%, #313131), linear-gradient(90deg, #9c6727, #fdf6ae 31.53%, #bd8d42 64.87%, #fdf6ae) !important;" id="withdraw_pc">
								<div class="-text-container">
						...
						<a href="#" id="wheelspinufa">
							<button class="btn btn-primary mt-lg-3" style="margin-right: 0.3rem !important;     background-image: linear-gradient(360deg, #ff03d9, #121212 51.68%, #313131), linear-gradient(90deg, #9c6727, #fdf6ae 31.53%, #bd8d42 64.87%, #fdf6ae) !important;" id="wheelspin_pc">
								<div class="-text-container">
			...
			<div class="container -container-wrapper">
				<div class="row -top-row-wrapper">
					...
					<div class="col-12 col-lg-6 col-xl-5 -top-row-right-wrapper">
						...
						<div class="-title">
							<div class="textwidget">UFAPLUS 888 คาสิโนสดที่นิยมมากที่สุด Sexy Gaming สู่ UFAPLUS-888 ตื่นเต้นสดใหม่ยิ่งขึ้น</div>
						</div>


						<div class="btn -btn -btn-image-primary">
							<div class="-fake-bg-wrapper">
								<img src="images/btn-base-glow.png" class="-fake-bg-glow" alt="UFAPLUS-888 Casino รูปปุ่มแสงสมัครสมาชิก">
							</div>
							<div class="-real-content-wrapper">
								<div class="-bg-img">
									...
									<?php  } else { ?>
										<div class="-btn-text"><a href="#" data-toggle="modal" data-target="#modal-games">ทางเข้าเล่น Game</a></div><a href="#" data-toggle="modal" data-target="#modal-games"><img width="500" height="160" src="images/btn-primary-bg.png" class="image wp-image-719  attachment-full size-full" alt="" loading="lazy" style="max-width: 100%; height: auto;" srcset="images/btn-primary-bg.png 500w, images/btn-primary-bg.png 300w" sizes="(max-width: 500px) 100vw, 500px"></a>
									<?php } ?>
								</div>
							</div>
						</div>
							...
							<?php if ($user) { ?>
								<section class="-section-wrapper-2">
									<div class="-line-separate-container">
										<img src="images/line-glow-red.png" class="-red-line" alt="UFAPLUS-888 Casino รูปภาพเส้นสีเรืองแสง" width="480" height="104">
									</div>
									<div class="x-index-tab-container">
										<div class="container">
											<ul class="nav nav-tabs x-tab py-3">
												...
												<!-- Edit By Firework -->
												<li class="nav-item  -index js-tab-scrolled">
													<a href="#" class="nav-link active" onclick="openModalPromotion();">
														<img src="build/web/ufacoder/img/box-main.png" alt="logo_promotion" class="-ic"><br>
														<br>

														<span class="d-sm-none d-inline-block mt-2 text-gray-lighter">โปรโมชั่นทดสอบ</span>
														<span class="d-sm-inline-block d-none mt-2 text-gray-lighter">โปรโมชั่นทดสอบ</span>
														<hr class="x-hr-border-glow mb-0">
													</a>
												</li>
												<li class="nav-item  -index js-tab-scrolled">
													<a href="#" class="nav-link active" onclick="openModalWinloss();">
														<img src="build/web/ufacoder/img/box-main.png" alt="logo_promotion" class="-ic"><br>
														<br>

														<span class="d-sm-none d-inline-block mt-2 text-gray-lighter">คืนยอดเสีย</span>
														<span class="d-sm-inline-block d-none mt-2 text-gray-lighter">คืนยอดเสีย</span>
														<hr class="x-hr-border-glow mb-0">
													</a>
												</li>
												<!--END Edit By Firework -->
										...
										<div class="col-12 col-lg-7 -left-container">
											<div class="-box-wrapper">
												<div class="-description">
													<div class="-title cutcolor">UFAPLUS-888</div>
									...
									<div class="row">
										<div class="col-12">
											<div class="-heading-wrapper">
												<div class="-sub-title">
													<div class="-title">ufaplus-888 คาสิโน สำหรับทุกคน</div>
													<div class="textwidget">
							...
							<section class="-section-wrapper-3">
								<div class="container">
									<div class="row">
										...
										<div class="col-12">
											<div class="-description">
												<div class="textwidget">เว็บอันดับหนึ่ง UFAPLUS-888 ที่รวมสาวสวยมากมายให้ท่านได้ตื่นตาตื่นใจ บาคาร่าออนไลน์ที่ เย้ายวนใจที่สุดในตอนนี้ หรือ ที่รู้จักกันว่า Baccaat,Gaming</div>
											</div>
										</div>
									</div>
								</div>
			...
			<div class="footercontain">
				<div class="disfooterct">
					<div class="infootergrid pt-3">
						<div class="mx-auto">
							<h2 class="widgettitle">ufaplus-888</h2>
					...
					<div class="x-login-form">
						<div data-animatable="fadeInModal" data-offset="0" class="-animatable-container animated fadeInModal">
							<div class="-x-input-icon mb-3 flex-column">
								...
								<input type="text" id="fname" name="fname" class="form-control x-form-control" placeholder="ชื่อ-นามสกุล (ไม่ต้องใส่คำนำหน้า)">
							</div>
							<div class="-x-input-icon mb-3 flex-column">
							...
							<div class="-x-input-icon mb-3 flex-column">
								<img src="build/web/ufacoder/img/password.png" class="-icon" alt="login" width="20">
								<input type="text" id="line" name="line" placeholder="ไอดีไลน์ หากไม่มีไม่ต้องใส่" class="form-control x-form-control">

							</div>
							<span id="notice_truewallet"></span>
				...
				<div class="modal-body">
					<div class="x-login-form">
						<div data-animatable="fadeInModal" data-offset="0" class="-animatable-container animated fadeInModal">
							...
							<select id="select" class="form-control" onchange="checkTrueWallet()">
	...
	?>
		...
		<!-- Edit By Firework -->
		<div class="x-modal modal" id="modal-promotion_test" tabindex="-1" role="dialog" data-loading-container=".js-modal-content" data-ajax-modal-always-reload="true" style="display: none;" aria-hidden="true">
			<div class="modal-dialog -modal-size -modal-big" role="document" style="margin-top: 203.922px;">
				<div class="modal-content -modal-content">
					<img src="build/web/ufacoder/img/border-modal.png" class="img-fluid d-lg-block d-none -border-top-modal" alt="">
					<button type="button" class="close f-1" data-dismiss="modal" aria-label="Close">
			...
			<div class="modal-dialog modal-dialog-centered -modal-size " role="document" style="padding-top: 60px;background-image: 0 !important;background: 0 !important;">
				<div class="modal-content -modal-content" style="border: 2px solid #fdd741;">
					...
					<div class="modal-body" style="top: 5px;padding:0px;overflow: auto;">
						...
						<br>
						<h2 class="text-center" style="color: rgb(233, 33, 19);" id="ufaplus-8882">เลือกเพื่อเล่น !</h2>
						<br>
		...
		<!-- GAME MODAL -->
		<div class="x-modal modal" id="modal-games" tabindex="-1" role="dialog" data-loading-container=".js-modal-content" data-ajax-modal-always-reload="true" style="display: none;" aria-hidden="true">
			<div class="modal-dialog -modal-size -modal-big" role="document" style="margin-top: 203.922px;">
				<div class="modal-content -modal-content">
					<img src="build/web/ufacoder/img/border-modal.png" class="img-fluid d-lg-block d-none -border-top-modal" alt="">
					<button type="button" class="close f-1" data-dismiss="modal" aria-label="Close">
						...
						<div class="x-pending ">
							<div class="d-lg-block d-none">
								...
								<div class="col d-flex flex-column animated fadeInModal" data-animatable="fadeInModal">
									<div class="row">
										<div class="col-6 text-center">
											<div class="btn -btn -btn-image-primary">
												<div class="-real-content-wrapper">
													<div class="-bg-img">
														<div class="-btn-text"><a href="game">ทางเข้าเล่น คาสิโน,เกมส์</a></div><a href="game"><img width="500" height="160" src="images/btn-primary-bg.png" class="image wp-image-719  attachment-full size-full" alt="" loading="lazy" style="max-width: 100%; height: auto;" srcset="images/btn-primary-bg.png 500w, images/btn-primary-bg.png 300w" sizes="(max-width: 500px) 100vw, 500px"></a>
													</div>
												</div>
											</div>
										</div>
										<div class="col-6 text-center">
											<div class="btn -btn -btn-image-primary" onclick="LoginLottoNew()">
												<div class="-real-content-wrapper">
													<div class="-bg-img">
														<div class="-btn-text"><a href="#">ทางเข้าเล่น หวย ใหม่</a></div><a href="#">
															<img width="500" height="160" src="images/btn-primary-bg.png" class="image wp-image-719  attachment-full size-full" alt="" loading="lazy" style="max-width: 100%; height: auto;" srcset="images/btn-primary-bg.png 500w, images/btn-primary-bg.png 300w" sizes="(max-width: 500px) 100vw, 500px"></a>
													</div>
												</div>
											</div>
										</div>
									...
									<br>
									<div class="row">
										<div class="col-6 text-center game-to-wallet">
											<div class="btn -btn -btn-image-primary">
												<div class="-real-content-wrapper">
													<div class="-bg-img">
														<div class="-btn-text "><a href="#">โยกเงินเข้าเครดิต</a></div><a href="#"><img width="500" height="160" src="images/btn-primary-bg.png" class="image wp-image-719  attachment-full size-full" alt="" loading="lazy" style="max-width: 100%; height: auto;" srcset="images/btn-primary-bg.png 500w, images/btn-primary-bg.png 300w" sizes="(max-width: 500px) 100vw, 500px"></a>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-12 text-center">
												<div class="btn -btn -btn-image-primary" onclick="LoginLottoNew()">
													<div class="-real-content-wrapper">
														<div class="-bg-img">
															<div class="-btn-text"><a href="#">ทางเข้าเล่น หวย</a></div><a href="#"><img width="500" height="160" src="images/btn-primary-bg.png" class="image wp-image-719  attachment-full size-full" alt="" loading="lazy" style="max-width: 100%; height: auto;" srcset="images/btn-primary-bg.png 500w, images/btn-primary-bg.png 300w" sizes="(max-width: 500px) 100vw, 500px"></a>
														</div>
													</div>
												</div>
											</div>
											...
											<br>
											<br>
											<div class="col-12 text-center game-to-wallet">
												<div class="btn -btn -btn-image-primary">
													<div class="-real-content-wrapper">
														<div class="-bg-img">
															<div class="-btn-text "><a href="#">โยกเงินเข้าเครดิต</a></div><a href="#"><img width="500" height="160" src="images/btn-primary-bg.png" class="image wp-image-719  attachment-full size-full" alt="" loading="lazy" style="max-width: 100%; height: auto;" srcset="images/btn-primary-bg.png 500w, images/btn-primary-bg.png 300w" sizes="(max-width: 500px) 100vw, 500px"></a>
	...
	<script>
		function checkTrueWallet() {
			let sel = document.getElementById('select').value;
			if (sel == 'truewallet') {
				document.getElementById('bank_number').value = document.getElementById('phone_otp').value;
				// document.getElementById('bank_number').disabled = true;
			} else {
				document.getElementById('bank_number').placeholder = 'เลขบัญชีธนาคาร';
				document.getElementById('bank_number').value = '';
				document.getElementById('bank_number').disabled = false;
			}
		}
				...
				$.ajax({
					...
					success: function(data) {
						if (data.stats == false) {
							...
							$.ajax({
								url: url_backend + '/ApiUpdateLastLogin',
								method: 'post',
								data: {
									id: <?= $info["id"] ?>,
								},
	...
	<script>
		...
		//     htm = `<span>ห้ามโอนเงิน เวลา 23.00 - 24.00<br><br><br><br>
		//         ระบบจะไม่อัพยอด <br><br><br><br>
		//         ระบบถอนยังสามารถดำเนินการได้ตามปกติ</span>`;
		// } else {
		//     `<span>ห้ามโอนเงิน เวลา 23.00 - 24.00<br>
		//         ระบบจะไม่อัพยอด <br>
		//         ระบบถอนยังสามารถดำเนินการได้ตามปกติ</span>`;
		// };
		// Swal.fire(
		//     'แจ้งเตือน !',
		//     document.documentElement.clientWidth <= 992 ? `<span>ห้ามโอนเงิน เวลา 23.00 - 24.00<br><br><br><br>
		//         ระบบจะไม่อัพยอด <br><br><br><br>
		//         ระบบถอนยังสามารถดำเนินการได้ตามปกติ</span>` : `<span>ห้ามโอนเงิน เวลา 23.00 - 24.00<br>
		//         ระบบจะไม่อัพยอด <br>
		//         ระบบถอนยังสามารถดำเนินการได้ตามปกติ</span>`,
		//     'warning'
		// );
	...
	<script>
		...
		const text = document.getElementById('ufaplus-888');
		const text2 = document.getElementById('ufaplus-8882');
										...
										$.ajax({
											...
											success: function(data) {
												if (data.result.statusCode == 200) {
													window.location.href = 'loginlotto/' + data.result.token;
												}
											}
										})
									}
				...
				$.ajax({
					...
					success: function(data) {
						...
						for (let i = 0; i < data.data.length; i++) {
							htm += `<option value="${data.data[i].id}">${data.data[i].name}  [${data.data[i].pro_type}]</option>`;
						}
