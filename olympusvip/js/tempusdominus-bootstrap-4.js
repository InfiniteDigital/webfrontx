        ...
        TempusDominusBootstrap4.prototype._getTimePickerMainTemplate = function _getTimePickerMainTemplate() {
            ...
            if (this._isEnabled('m')) {
                ...
                middleRow.append($('<td>').append($('<span>').addClass('timepicker-minute').attr({
                    ...
                    //click on close
                    sync.widget.hide();
                    $(window).off('resize', sync._place());
                    sync.widget.off('click', '[data-action]');
                    sync.widget.off('mousedown', false);
                    ...
                    sync._notifyEvent({
                        ...
                        date: sync._getLastPickedDate().clone()
                    });
                    if (sync.input !== undefined) {
                        sync.input.blur();
                    }
                    sync._viewDate = sync._getLastPickedDate().clone();
                    //console.info(sync);
                })));
                bottomRow.append($('<td>').append($('<a>').attr({
                    href: '#',
