...
<style>
	...
	.boxgame[_ngcontent-gca-c154] {
		background-color: transparent !important;
	}
</style>
<app-root _nghost-asb-c187="" ng-version="9.1.13">
	<div _ngcontent-asb-c187="" id="app" class="container">
		...
		<app-main _nghost-asb-c14="" class="ng-star-inserted">
			...
			<div id="section-content" class="container mb-2">
						...
						<div class="d-flex justify-content-center ">
							<div class="col-4">
								<a href="javascript:void(0)" data-toggle="modal" data-target="#Deposit">
									<div class="btn btn-block bg-galaxy">
										<div>
					...
					<div class="col-4">
						<div class="d-flex justify-content-center ">
							<div class="col-12 my-2">
								<a href="javascript:void(0)" class="btn btn-block btn-move-main rounded game-to-wallet" style="color:#6f4900;border: #0023ffb3 1px solid;font-size: 1.2rem;">
				...
				<div _ngcontent-gca-c154="" class="container text-theme-primary rounded p-2 px-3 xtarget col-lotto ng-star-inserted pc-view ">
				...
				<div _ngcontent-asb-c14="" class="container p-0 m-1  mobile-view">
					<?php if (!empty($banner)) : ?>
						<div _ngcontent-gca-c154="" class="d-flex justify-content-center">
							...
							<div _ngcontent-nbo-c179="" class="banner-colosal ng-star-inserted">
								<mdb-carousel _ngcontent-nbo-c179="" class="carousel slide">
									<div tabindex="0" class="carousel slide">
										<div id="carouselExampleIndicatorsRR" class="carousel slide" data-bs-ride="carousel">
											<ol class="carousel-indicators ng-star-inserted">
												<?php foreach ($banner as $k => $v) : ?>
													<?php if ($v->checkhome == 1) : ?>
														<?php if ($k == 0) : ?>
												...
												<?php foreach ($banner as $k => $v) : ?>
													<?php if ($v->checkhome == 1) : ?>
														...
														<?php endforeach; ?>
															...
															<a class="carousel-control-prev" href="#carouselExampleIndicatorsRR" role="button" data-slide="prev">
																<span class="carousel-control-prev-icon" aria-hidden="true"></span>
																<span class="sr-only">Previous</span>
															</a>
															<a class="carousel-control-next" href="#carouselExampleIndicatorsRR" role="button" data-slide="next">
																<span class="carousel-control-next-icon" aria-hidden="true"></span>
																<span class="sr-only">Next</span>
															</a>
											</div>
				...
				<div _ngcontent-asb-c14="" class="row justify-content-center py-3 px-2 mx-1 mobile-view">
					<div _ngcontent-gca-c154="" class="container row boxgame">
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded">
								<a _ngcontent-gca-c154="" target="_blank" href="game">
									<img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/assets/sports.png" cursorshover="true">
								</a>
							</div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" href="#">
									<img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/assets/minigame.png" cursorshover="true"></a></div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" href="javascript:void(0)" onclick="LoginLottoNew()"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/assets/yeekee.png" cursorshover="true"></a></div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" target="_blank" href="game"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/assets/casino.png" cursorshover="true"></a></div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" href="javascript:void(0)" onclick="LoginLottoNew()"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/assets/lotto.png" cursorshover="true"></a></div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded">
						...
						<div _ngcontent-gca-c154="" class="row " style="padding: 10px;">
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1" onclick="LoginLottoHistory()">
								<div _ngcontent-ont-c14="" class="text-center px-2" style="position: relative; margin-bottom: 15px;">
									<a _ngcontent-ont-c14="" href="#" class="btn-main-menu-mobile"><img _ngcontent-ont-c14="" src="<?= $theme_asset ?>/assets/icon/icon.png" style="width: 100%; height: auto;">
										โพยหวย </a>
								</div>
							</div>
							...
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1">
								<div _ngcontent-ont-c14="" class="text-center px-2" style="position: relative;margin-bottom: 15px;"><a _ngcontent-ont-c14="" href="#" data-toggle="modal" data-target="#number_lotto" class="btn-main-menu-mobile"><img _ngcontent-ont-c14="" src="<?= $theme_asset ?>/assets/icon/icon2.png" style="width: 100%; height: auto;">
										สร้างเลขชุด </a></div>
							</div>
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1">
							...
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1">
								<div _ngcontent-ont-c14="" class="text-center px-2" style="position: relative;margin-bottom: 15px;"><a _ngcontent-ont-c14="" href="javascript:void(0);" data-toggle="modal" data-target="#vip_group" class="btn-main-menu-mobile"><img _ngcontent-ont-c14="" src="<?= $theme_asset ?>/assets/icon/icon7.png" style="width: 100%; height: auto;">
										กลุ่มเลขเด็ด </a></div>
							</div>
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1" onclick="LoginLottoAwards()">
								<div _ngcontent-ont-c14="" class="text-center px-2" style="position: relative;margin-bottom: 15px;">
									<a _ngcontent-ont-c14="" href="#/result-all" routerlink="/result-all" class="btn-main-menu-mobile">
										<img _ngcontent-ont-c14="" src="<?= $theme_asset ?>/assets/icon/icon3.png" style="width: 100%; height: auto;">
										ผลรางวัล
									</a>
								</div>
							</div>
				...
				<div class="row justify-content-center pc-view">
					<div _ngcontent-gca-c154="" class="container row boxgame">
						...
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" href="#"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/assets/minigame.png" cursorshover="true"></a></div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" href="javascript:void(0)" onclick="LoginLottoNew()"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/assets/yeekee.png" cursorshover="true"></a></div>
						</div>
					...
					<div _ngcontent-gca-c154="" class="container boxgame pc-view" style="color: white !important;background:none;">
						...
						<div _ngcontent-gca-c154="" class="row row-menu-grid" style="color: white !important;">
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 mb-2" style="position: relative;" onclick="LoginLottoHistory()">
									<a href="#" class=""><img src="<?= $theme_asset ?>/assets/icon/icon.png" style="width: 100%; height: auto;">
							...
							<div class="col-4 col-sm-4 col-md-3 col-lg-2" onclick="getLottoNumberGroup()">
								<div class="text-center px-2 mb-2" style="position: relative;">
									<a href="#" data-toggle="modal" data-target="#number_lotto" class="">
										<img src="<?= $theme_asset ?>/assets/icon/icon2.png" style="width: 100%; height: auto;">
							...
							<div class="col-3 col-sm-3 col-md-3 col-lg-2" onclick="LoginLottoAwards()">
								<div class="text-center px-2 mb-2" style="position: relative;"><a href="#" class="">
										<img src="<?= $theme_asset ?>/assets/icon/icon3.png" style="width: 100%; height: auto;">
							...
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 mb-2" style="position: relative;"><a href="#" data-toggle="modal" data-target="#vip_group" class=""><img src="<?= $theme_asset ?>/assets/icon/icon7.png" style="width: 100%; height: auto;">
								...
								<div class="col d-flex flex-column js-slide-left-content x-slide-left-content">
									<div class="js-content mx-auto text-center animated fadeInModal" data-animatable="fadeInModal" data-delay="1500">
										...
										<div class="text-center d-flex flex-column">
											<?php foreach ($bankall as $bb) : ?>
												<?php if ($bb->status) : ?>
													<div class="mb-3">
														<div class="media m-auto d-inline-flex">
															<div class="row">
																<img src="<?= $baseurl ?>images/bank2/<?= $bb->type ?>.jpg" alt="<?= $bb->type; ?>" width="50px" class="rounded mr-3">
															</div>
															<div class="media-body text-left d-flex flex-column px-3">
																<div class="d-flex flex-lg-column flex-row">
																	<span class="text-primary">
																		<span class="h4"><?= $bb->accnum ?></span>
																		<span class="<?= $bb->type ?><?= $bb->accnum ?>" style="font-size: 14px;" onclick="clipboradacc('<?= $bb->accnum ?>','<?= $bb->type ?><?= $bb->accnum ?>')">
																			<a href="#" class="text-black">
																				<i class="fa fa-copy text-info" style="font-size: 18px !important;"></i> คัดลอก
																			</a>
																		</span>
																	</span>
										...
										<div class="x-admin-contact ">
											<span class="x-text-with-link-component">
												...
												<a href="https://line.me/R/ti/p/<?= $line ?>" id="contact-line" target="_blank">
													<span id="contact-line" class="text-primary">ติดต่อฝ่ายบริการลูกค้า</span>
												</a>
											</span>
										</div>
									</div>
								...
								<div class="js-content -animatable-container m-auto text-center animated fadeInModal" data-animatable="fadeInModal" data-delay="0">
									...
									<?php foreach ($bankall as $bb) : ?>
                                                <?php if ($bb->status) : ?>
                                                    <div class="mb-3">
                                                        <div class="media m-auto d-inline-flex">
                                                            <img src="<?= $baseurl ?>/images/bank2/<?= $bb->type ?>.jpg" alt="bank-bay" width="50px" class="rounded">
                                                            <div class="media-body text-left d-flex flex-column px-3">
                                                                <div class="d-flex flex-lg-column flex-row">
                                                                    <span class="text-primary">
                                                                        <span class="h4"><?= $bb->accnum ?></span>
                                                                        ...
                                                                        <p class="text-black f-5"><?= $bb->name ?></p>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script>
	...
	<?php if ($user) : ?>
		...
		function clipboradacc(bankacc, clsass) {
            var clipboard5 = new ClipboardJS(`.${clsass}`, {
            ...
            clipboard5.on('success', function(e) {
                Swal.fire({
                    icon: 'success',
                    title: 'สำเร็จ',
                    text: 'คัดลอกเลขบัญชีแล้ว ' + bankacc
                })
            });
        }
