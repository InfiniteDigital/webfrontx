...
<head>
    ...
    <meta property="og:title" content="WEBTEST-AUTO">
    <meta property="og:image" content="<?= $theme_asset ?>/assets/icons/icon-384x384.png">
...
<body class="disable-dbl-tap-zoom">
    <app-root _nghost-qbu-c187="" ng-version="9.1.13">
        <div _ngcontent-qbu-c187="" id="app" style="min-height: calc(100% - 60px); overflow: hidden;">
            ...
            <nav _ngcontent-qbu-c187="" id="sidebar" hidden="">
                <div _ngcontent-qbu-c187="" id="dismiss"><i _ngcontent-qbu-c187=""
                        class="fas fa-backspace fa-flip-horizontal"></i></div>
                <div _ngcontent-qbu-c187="" class="sidebar-header">
                    <div _ngcontent-qbu-c187="" class="align-center text-center"><img _ngcontent-qbu-c187=""
                            src="<?= $theme_asset ?>/img/user-128.png" alt="หวยฮานอย" width="110" height="100"
                            onerror="this.src='<?= $theme_asset ?>/img/user-128.png'" class="rounded-circle"><br
                            _ngcontent-qbu-c187=""><span _ngcontent-qbu-c187="" class="username"></span><br
                            _ngcontent-qbu-c187=""><i _ngcontent-qbu-c187="" class="fas fa-coins"></i><span
                            _ngcontent-qbu-c187="" data-id="credit_balance" class="badge badge-pill badge-danger thb"
                            style="margin-left: 5px;"> ฿</span></div>
                </div>
                <ul _ngcontent-qbu-c187="" class="list-unstyled components">
                    <li _ngcontent-qbu-c187=""><a _ngcontent-qbu-c187="" href="#/setting-profile"
                            routerlink="/setting-profile"><i _ngcontent-qbu-c187="" class="fas fa-user-cog"></i>
                            ตั้งค่าบัญชีผู้ใช้</a></li>
                    <li _ngcontent-qbu-c187=""><a _ngcontent-qbu-c187="" href="#/setting-bank"
                            routerlink="/setting-bank"><i _ngcontent-qbu-c187="" class="fas fa-money-check"></i>
                            บัญชีธนาคาร</a></li>
                    <li _ngcontent-qbu-c187=""><a _ngcontent-qbu-c187="" href="#/howto" routerlink="/howto"><i
                                _ngcontent-qbu-c187="" class="fas fa-info-circle"></i> วิธีใช้งาน</a></li>
                    <li _ngcontent-qbu-c187=""><a _ngcontent-qbu-c187="" href="#" data-toggle="modal"
                            data-target="#Contactbox"><i _ngcontent-qbu-c187="" class="fas fa-handshake"></i>
                            ศูนย์ช่วยเหลือ</a></li>
                </ul>
                <ul _ngcontent-qbu-c187="" class="list-unstyled CTAs">
                    <li _ngcontent-qbu-c187=""><a _ngcontent-qbu-c187="" href="javascript:void(0);" class="logout"><i
                                _ngcontent-qbu-c187="" class="fas fa-sign-out-alt"></i> ออกจากระบบ </a></li>
                </ul>
            </nav>
                ...
                <div _ngcontent-qbu-c187="" class="topnavbar">
                    <div _ngcontent-qbu-c187="" class="container">
                        <div _ngcontent-qbu-c187="" class="d-flex justify-content-between align-items-center">
                            <div _ngcontent-qbu-c187="" class="d-flex align-items-center"><a _ngcontent-qbu-c187=""
                                    href="/" routerlink="/main" title="HENG168">
                                    <div _ngcontent-qbu-c187="" class="memberlogo">
                                    </div>
                                </a></div>
                            <div _ngcontent-qbu-c187=""
                                class="d-flex flex-row justify-content-between align-items-center">
                                <div _ngcontent-qbu-c187="" id="menu-pc"
                                    class="d-flex justify-content-between align-items-center pc-view"><a
                                        _ngcontent-qbu-c187="" href="#/main" routerlink="/main" data-toggle="tooltip"
                                        data-placement="bottom" title="" data-id="lotto"
                                        data-original-title="หน้าแรก"><i _ngcontent-qbu-c187=""
                                            class="sn-icon sn-icon--home2"></i></a><a _ngcontent-qbu-c187=""
                                        href="#/lottery" routerlink="/lottery" data-toggle="tooltip"
                                        data-placement="bottom" title="" data-id="lottery"
                                        data-original-title="แทงหวย"><i _ngcontent-qbu-c187=""
                                            class="fas fa-star"></i></a><a _ngcontent-qbu-c187="" href="#/result-all"
                                        routerlink="/result-all" data-toggle="tooltip" data-placement="bottom" title=""
                                        data-id="award" data-original-title="ผลรางวัล"><i _ngcontent-qbu-c187=""
                                            class="fas fa-award"></i></a><a _ngcontent-qbu-c187="" href="#/deposit"
                                        routerlink="/deposit" data-toggle="tooltip" data-placement="bottom" title=""
                                        data-id="refill" data-original-title="ฝากเงิน"><i _ngcontent-qbu-c187=""
                                            class="fas fa-donate"></i></a>
                                    <div _ngcontent-qbu-c187="" class="linemenu-x"></div>
                                </div>
                                <div _ngcontent-qbu-c187="" id="re-credit"><span _ngcontent-qbu-c187=""
                                        data-id="credit_balance" class="badge badge-pill badge-light thb"> ฿</span>
                                </div><a _ngcontent-qbu-c187="" href="#" data-toggle="modal" data-target="#Contactbox">
                                    <div _ngcontent-qbu-c187="" class="btn-line"></div>
                                </a>
                                <div _ngcontent-qbu-c187="" id="sidebarCollapse" class="mobile-view"><img
                                        _ngcontent-qbu-c187="" src="<?= $theme_asset ?>/img/user-128.png"
                                        alt="หวยฮานอย วันนี้ ออกอะไร"
                                        onerror="this.src='<?= $theme_asset ?>/img/user-128.png'" width="28" height="28"
                                        title="บัญชีผู้ใช้" class="rounded-circle ml-1"><i _ngcontent-qbu-c187=""
                                        class="fas fa-ellipsis-v" style="margin-left: 5px;"></i>
                                </div>
                                <div _ngcontent-qbu-c187="" class="dropdown pc-view ml-1">
                                    <div _ngcontent-qbu-c187="" id="menu-profile" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="true" class="dropdown-toggle"><img
                                            _ngcontent-qbu-c187="" src="<?= $theme_asset ?>/img/user-128.png"
                                            alt="หวยฮานอย วันนี้ ออกอะไร"
                                            onerror="this.src='<?= $theme_asset ?>/img/user-128.png'" width="40"
                                            height="35" class="rounded-circle"><span _ngcontent-qbu-c187=""
                                            id="username" class="ml-1"></span></div>
                                    <div _ngcontent-qbu-c187="" aria-labelledby="menu-profile"
                                        id="menu-profile-dropdown" class="dropdown-menu"><a _ngcontent-qbu-c187=""
                                            href="#/setting-profile" routerlink="/setting-profile"
                                            class="dropdown-item"><i _ngcontent-qbu-c187="" class="fas fa-user-cog"></i>
                                            ตั้งค่าบัญชีผู้ใช้ </a><a _ngcontent-qbu-c187="" href="#/setting-bank"
                                            routerlink="/setting-bank" class="dropdown-item"><i _ngcontent-qbu-c187=""
                                                class="fas fa-money-check"></i> บัญชีธนาคาร </a><a
                                            _ngcontent-qbu-c187="" href="#/howto" routerlink="/howto"
                                            class="dropdown-item"><i _ngcontent-qbu-c187=""
                                                class="fas fa-info-circle"></i> วิธีใช้งาน </a><a _ngcontent-qbu-c187=""
                                            href="#" data-toggle="modal" data-target="#Contactbox"
                                            class="dropdown-item"><i _ngcontent-qbu-c187=""
                                                class="fas fa-handshake"></i> ศูนย์ช่วยเหลือ </a>
                                        <div _ngcontent-qbu-c187="" class="dropdown-divider"></div><a
                                            _ngcontent-qbu-c187="" href="javascript:void(0);" class="dropdown-item"><i
                                                _ngcontent-qbu-c187="" class="fas fa-sign-out-alt"></i> ออกจากระบบ </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div _ngcontent-qbu-c187="" class="container">
                    <div _ngcontent-qbu-c187="" style="height: 150px;" class="ng-star-inserted">
                        <div _ngcontent-qbu-c187="" class="row v-toolbar--rule">
                            <div _ngcontent-qbu-c187="" class="text-left p-2 col pc-view"><strong _ngcontent-qbu-c187=""
                                    data-toggle="modal" data-target="#ModalRate" class="d-none d-sm-inline-block"
                                    style="cursor: pointer;">อัตราจ่าย</strong><span _ngcontent-qbu-c187=""
                                    class="d-none d-sm-inline-block" style="padding: 0px 0.5rem;">|</span><strong
                                    _ngcontent-qbu-c187="" data-toggle="modal" data-target="#ModalRule"
                                    class="d-none d-sm-inline-block" style="cursor: pointer;">กฏกติกา</strong></div>
            ...
            <div _ngcontent-qbu-c187="" class="container">
                <div _ngcontent-qbu-c187="" id="ModalRule" tabindex="-1" role="dialog" aria-labelledby="ModalRule"
                    ...
                    <div _ngcontent-qbu-c187="" role="document" class="modal-dialog modal-lg">
                        <div _ngcontent-qbu-c187="" class="modal-content" style="border-radius: 10px;">
                            <div _ngcontent-qbu-c187="" class="modal-header bg-theme-primary">
                                <h5 _ngcontent-qbu-c187="" class="modal-title">กฏและกติกา</h5><button
                                    _ngcontent-qbu-c187="" type="button" data-dismiss="modal" aria-label="Close"
                                    class="text-white close"><span _ngcontent-qbu-c187=""
                                        aria-hidden="true">×</span></button>
                            </div>
                            <div _ngcontent-qbu-c187="" class="modal-body">
                                <p _ngcontent-qbu-c187=""><span _ngcontent-qbu-c187=""
                                        class="pl-3">ยินดีต้อนรับสู่หวยออนไลน์</span>
                                    ...
                                    เมื่อสมัครสมาชิกแล้วทางเว็บจะถือว่า สมาชิกได้อ่านและยอมรับ <span
                                        _ngcontent-qbu-c187=""
                                        class="text-primary">"นโยบายและเงื่อนไขการให้บริการของเว็บไซต์์"</span>
                                </p>
                                <p _ngcontent-qbu-c187=""><strong _ngcontent-qbu-c187=""><u _ngcontent-qbu-c187=""
                                            style="color: #3b5898;">การรักษาและช่วยเหลือการเดิมพันออนไลน์์</u></strong><br
                                        _ngcontent-qbu-c187=""></p>
                                <ul _ngcontent-qbu-c187="" class="pl-3">
                                    ...
                                    <li _ngcontent-qbu-c187="">ไม่ต้องวิตกกังวล ถ้าสมาชิกออกจากเว็บไซด์ระหว่างการเดิมพัน
                                        สมาชิกจะถูกออกจากระบบช่วงเวลาหนึ่ง จากนั้นสมาชิกสามารถเข้าสู่ระบบ <a
                                            _ngcontent-qbu-c187="" href="https:">HENG168</a> ได้อีกครั้งตามปกติ</li>
                                </ul>
                                <p _ngcontent-qbu-c187=""></p>
                                <p _ngcontent-qbu-c187=""><strong _ngcontent-qbu-c187=""><u _ngcontent-qbu-c187=""
                                            style="color: #3b5898;">การให้ความคุ้มครอง</u></strong><br
                                        _ngcontent-qbu-c187=""><a _ngcontent-qbu-c187="" href="https:">HENG168</a>
                                    ...
                                    และทางเราจะตอบกลับอย่างรวดเร็วที่สุด <a _ngcontent-qbu-c187=""
                                        href="https:">HENG168</a>
                                    ขอรับรองว่าจะรักษาข้อมูลส่วนตัวของท่านไว้เป็นความลับอย่างปลอดภัย </p>
                                <p _ngcontent-qbu-c187=""><strong _ngcontent-qbu-c187=""><u _ngcontent-qbu-c187=""
                                            style="color: #3b5898;">ข้อตกลงในการเดิมพัน</u></strong><br
                                        _ngcontent-qbu-c187=""></p>
                                <ul _ngcontent-qbu-c187="" class="pl-3">
                                    <li _ngcontent-qbu-c187="">เพื่อหลีกเลี่ยงปัญหาต่างๆในขณะที่ใช้งานเว็บไซต์
                                        ...
                                        เมื่อสมาชิกเข้าสู่หน้าเดิมพันทางบริษัทจะถือว่าท่านได้ยอมรับข้อตกลงของทาง <a
                                            _ngcontent-qbu-c187="" href="https:">HENG168</a></li>
                                    <li _ngcontent-qbu-c187="">การเดิมพันจะต้องอยู่ใน <span _ngcontent-qbu-c187=""
                                            class="text-success">"ระยะเวลาที่กำหนด"</span>
                                        มิฉะนั้นจะถือว่าการเดิมครั้งนั้นเป็น <span _ngcontent-qbu-c187=""
                                            class="text-danger">"โมฆะ"</span>
                                        ถ้าการเดิมพันได้มีการยกเลิกหรือหยุดพักชั่วคราว
                                        เนื่องจากเหตุผลใดๆก็ตามก่อนการเล่น การเดิมพันครั้งนั้นจะถือว่าเป็น<span
                                            _ngcontent-qbu-c187=""
                                            class="text-danger">"โมฆะ"</span>และทางบริษัทจะคืนเครดิตให้กับสมาชิก </li>
                                    <li _ngcontent-qbu-c187="">เป็นความรับผิดชอบของสมาชิกที่จะคอยดูผลลัพธ์
                                        ...
                                        <span _ngcontent-qbu-c187=""
                                            class="text-primary">"รายละเอียดการวางเดิมพัน"</span> ของสมาชิก
                                ...
                                <p _ngcontent-qbu-c187=""></p>
                                <p _ngcontent-qbu-c187=""><strong _ngcontent-qbu-c187=""><u _ngcontent-qbu-c187=""
                                            style="color: #3b5898;">ระบบการรักษาความปลอดภัย</u></strong><br
                                        _ngcontent-qbu-c187=""></p>
                                <ul _ngcontent-qbu-c187="" class="pl-3">
                            ...
                            <div _ngcontent-qbu-c187="" class="modal-footer"><button _ngcontent-qbu-c187=""
                                    type="button" data-dismiss="modal" class="btn btn-theme-primary"
                                    style="width: -webkit-fill-available; box-shadow: -1px 2px 5px black;">ฉันเข้าใจและยอมรับ</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div _ngcontent-qbu-c187="" id="ModalRate" tabindex="-1" role="dialog" aria-labelledby="ModalRate"
                    aria-hidden="true" class="modal fade">
                    <div _ngcontent-qbu-c187="" role="document" class="modal-dialog modal-lg">
                        <div _ngcontent-qbu-c187="" class="modal-content" style="border-radius: 10px;">
                            <div _ngcontent-qbu-c187="" class="modal-header bg-theme-primary">
                                <h5 _ngcontent-qbu-c187="" class="modal-title">อัตราการจ่าย</h5><button
                                    _ngcontent-qbu-c187="" type="button" data-dismiss="modal" aria-label="Close"
                                    class="text-white close"><span _ngcontent-qbu-c187=""
                                        aria-hidden="true">×</span></button>
                            </div>
                            <div _ngcontent-qbu-c187="" class="modal-body text-center ng-star-inserted"><img
                                    _ngcontent-qbu-c187=""
                                    style="max-width: 100%; max-height: 100%; height: inherit !important;"
                                    src="https://api.heng-168.net/info/getBannerImage/13?1644203181"><br
                                    _ngcontent-qbu-c187=""></div>
                            <!---->
                            <!---->
                            <div _ngcontent-qbu-c187="" class="modal-footer"><button _ngcontent-qbu-c187=""
                                    type="button" data-dismiss="modal" class="btn btn-theme-primary"
                                    style="width: -webkit-fill-available; box-shadow: -1px 2px 5px black;">ปิด</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div _ngcontent-qbu-c187="" id="Contactbox" tabindex="-1" role="dialog" aria-labelledby="Contactbox"
                    aria-hidden="true" class="modal fade">
                    <div _ngcontent-qbu-c187="" role="document" class="modal-dialog modal-lg">
                        <div _ngcontent-qbu-c187="" class="modal-content" style="border-radius: 10px;">
                            <div _ngcontent-qbu-c187="" class="modal-header bg-theme-primary">
                                <h5 _ngcontent-qbu-c187="" class="modal-title">เลือกช่องทางการติดต่อเรา</h5><button
                                    _ngcontent-qbu-c187="" type="button" data-dismiss="modal" aria-label="Close"
                                    class="text-white close"><span _ngcontent-qbu-c187=""
                                        aria-hidden="true">×</span></button>
                            </div>
                            <div _ngcontent-qbu-c187="" class="modal-body">
                                <div _ngcontent-qbu-c187="" class="row ng-star-inserted">
                                    <div _ngcontent-qbu-c187="" class="col-6 col-sm-6 col-md-6 ng-star-inserted"
                                        data-index="0"><a _ngcontent-qbu-c187=""
                                            class="btn btn-outline-success btn-block btn-contactbox mb-3"
                                            style="margin-bottom: 0;" href="line://ti/p/@168h3"><span
                                                _ngcontent-qbu-c187=""><small _ngcontent-qbu-c187=""
                                                    class="d-flex justify-content-center">ติดต่อผ่านไลน์ &nbsp;
                                                    <!---->
                                                </small></span><i _ngcontent-qbu-c187="" class="fab fa-line"></i></a>
                                    </div>
                                    <!---->
                                    <div _ngcontent-qbu-c187="" class="col-6 col-sm-6 col-md-6"><a
                                            _ngcontent-qbu-c187="" href="#" onclick="Tawk_API.toggle();return false"
                                            data-dismiss="modal"
                                            class="btn btn-outline-danger btn-block btn-contactbox mb-0"><span
                                                _ngcontent-qbu-c187=""><small
                                                    _ngcontent-qbu-c187="">แชทสดกับพนักงาน</small></span><i
                                                _ngcontent-qbu-c187="" class="fa fa-user"></i></a></div>
                                    <!---->
                                </div>
                                <!---->
                                <!---->
            ...
            <app-register _nghost-qbu-c180="" class="ng-star-inserted">
                <div _ngcontent-qbu-c180="" class="container">
                    <section _ngcontent-qbu-c180="" id="contentbox" class="h-100 mb-5">
                        <div _ngcontent-qbu-c180=""
                            class="bg-theme-dark border border-secondary rounded px-3 py-2 mt-2">
                            <div _ngcontent-qbu-c180="" class="row">
                                <div _ngcontent-qbu-c180="" class="col-12 col-sm-12 col-md-6"></div>
                                <div _ngcontent-qbu-c180=""
                                    class="col-12 col-sm-12 col-md-6 text-center text-sm-center text-md-right">
                                    <h3 _ngcontent-qbu-c180="" class="mt-1 font-weight-light">สมัครสมาชิก</h3>
                                </div>
                            </div>
                        </div>
                        <?php if (!empty($banner)) : ?>
                        <div _ngcontent-qbu-c180="" class="main-banner-top my-2 pc-view">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item <?= ($k == 0) ? 'active' : '' ?>">
                                        <div _ngcontent-nbo-c179="" class="view w-100 ais-hero">
                                            <img _ngcontent-nbo-c179="" alt="หวยฮานอย vip วันนี้" class="d-block w-100"
                                                src="<?= $asset_backend . $v->img_name ?>">
                        ...
                        <div _ngcontent-qbu-c180="" class="mobile-view d-flex flex-column my-2">
                        ...
                        <?php endif; ?>
                        <div _ngcontent-qbu-c180="" id="form_phone"
                            class="bg-white border-secondary shadow-sm rounded p-3  mt-2 mb-5">

                            <div _ngcontent-qbu-c180="" class="row mb-3">
                                <div _ngcontent-qbu-c180="" class="col-12">
                                    <span _ngcontent-qbu-c180=""
                                        class="pc-view d-inline text-danger">*กรุณาใช้เบอร์โทรจริงของท่านในการสมัครเท่านั้น
                            ...
                            <div _ngcontent-qbu-c180="" class="row mb-3 mobile-view">
                                <div _ngcontent-qbu-c180="" class="col-12"><span _ngcontent-qbu-c180=""
                                        class="text-danger">*กรุณาใช้เบอร์โทรจริงของท่านในการสมัครเท่านั้น
                                        เบอร์นี้จะถูกยึดถือเป็นหลักในการทำธุรกรรมและไม่สามารถเปลี่ยนแปลงได้ภายหลัง</span>
                                </div>
                            </div>
                            <div _ngcontent-qbu-c180="" class="row">
                                <div _ngcontent-qbu-c180="" class="col-12 col-sm-12">
                                    <h6 _ngcontent-qbu-c180="" class="text-dark"><i _ngcontent-qbu-c180=""
                                            class="fas fa-mobile-alt"></i> ลงทะเบียนเบอร์โทรศัพท์</h6>
                                </div>
                                <div _ngcontent-qbu-c180="" class="col-8 col-sm-8 col-md-4"><input
                                        _ngcontent-qbu-c180="" type="tel" name="tel" id="phone"
                                        pattern="^0[6,8,9][0-9]{8}$" maxlength="10" required=""
                                        placeholder="ใส่เบอร์โทรศัพท์"
                                        class="form-control telinput ng-pristine ng-invalid ng-touched"></div>

                                <div _ngcontent-qbu-c180="" class="col-12 border-bottom my-3"></div>

                                <div _ngcontent-gre-c180=""
                                    class="col-12 col-sm-12 col-md-2 mb-2 d-flex align-items-center"><b
                                        _ngcontent-gre-c180="">รหัสผ่าน</b></div>
                                <div _ngcontent-gre-c180="" id="password" class="col-12 col-sm-12 col-md-9 mb-2"><input
                                        _ngcontent-gre-c180="" type="password" name="password" id="password_val"
                                ...
                                <div _ngcontent-gre-c180=""
                                    class="col-12 col-sm-12 col-md-2 mb-2 d-flex align-items-center"><b
                                        _ngcontent-gre-c180="">ยืนยันรหัสผ่าน</b></div>
                                <div _ngcontent-gre-c180="" id="repassword" class="col-12 col-sm-12 col-md-9 mb-2">
                                    <input _ngcontent-gre-c180="" type="password" name="repassword" id="repassword_val"
                                        placeholder="กรอก password อีกครั้ง" required="" minlength="4"
                            ...
                            <div class="row col-sm-12">
                                <div class="col">
                                    <a class="btn btn-danger btn-block" style="color: white;"
                                        href="/"><span>ยกเลิก</span></a>
                                </div>

                                <div class="col">
                                    <button class="btn btn-success btn-block" style="color: white;"
                                        onclick="next_bank()"><span>ถัดไป</span></button>
                                </div>
                            </div>
                        </div>
                        <div _ngcontent-hbb-c133="" id="form_bank" style="display: none;"
                            class="p-2 w-100 bg-light main-content align-self-stretch">
                            <div _ngcontent-hbb-c133=""
                                class="bgwhitealpha text-theme-primary shadow-sm rounded p-2 px-2 xtarget col-lotto d-flex flex-row mb-1 pb-0">
                                <div _ngcontent-hbb-c133="" class="lotto-title w-100 d-flex justify-content-between">
                                    <div _ngcontent-hbb-c133="" class="d-inline">
                                        <h4 _ngcontent-hbb-c133="" class="mr-1 d-inline"><i _ngcontent-hbb-c133=""
                                                class="fas fa-folder-plus"></i> เพิ่มบัญชีธนาคาร</h4>
                                    </div>
                                    <div _ngcontent-hbb-c133="" class="d-inline">
                            ...
                            <div _ngcontent-hbb-c133=""
                                class="bgwhitealpha text-theme-secondary shadow-sm rounded p-2 px-2 xtarget  d-flex flex-row mb-5 pb-0">
                                <div _ngcontent-hbb-c133="" style="display: block;">
                                    <div _ngcontent-hbb-c133="" class="form-row" style="padding-right: 33px !important;
                                        ...
                                        <div _ngcontent-hbb-c133="" class="col-12 col-sm-12 col-md-6" style="padding-right: 33px !important;
                                                padding-left: 22px !important;"><label _ngcontent-hbb-c133=""><i
                                                    _ngcontent-hbb-c133="" class="fas fa-university"></i>
                                                เลือกธนาคาร</label>
                                            <div _ngcontent-hbb-c133="" class="border rounded mb-2">
                                                <select _ngcontent-hbb-c133="" id="bank_name"
                                                    class="form-select form-select-sm mat-select selectpicker form-control ng-tns-c132-1 mat-select-empty"
                                        ...
                                        <div _ngcontent-hbb-c133="" class="col-12 col-sm-12 col-md-6 mb-1" style="padding-right: 33px !important;
                                                padding-left: 22px !important;">
                                            <label _ngcontent-hbb-c133=""><i _ngcontent-hbb-c133=""
                                                    class="fas fa-clipboard-check"></i>
                                                เลขที่บัญชี</label><input _ngcontent-hbb-c133="" type="text" id="acc"
                                                name="acc" placeholder="ระบุเฉพาะตัวเลข" maxlength="15"
                                                onchange="checkBankNew()"
                                                class="form-control bankinput ng-untouched ng-pristine ng-valid"><small
                                                _ngcontent-hbb-c133="" id="checkacc1"></small>
                                        </div>
                                        <div _ngcontent-hbb-c133="" class="col-12 col-sm-12 col-md-6" style="padding-right: 33px !important;
                                                padding-left: 22px !important;">
                                            <label _ngcontent-hbb-c133=""><i _ngcontent-hbb-c133=""
                                                    class="fas fa-id-card"></i> ชื่อบัญชี</label>
                                            <input _ngcontent-hbb-c133="" type="text" id="name" name="name"
                                                placeholder="เช็คสถานะบัญชีก่อน"
                                                class="form-control ng-untouched ng-pristine ng-valid" disabled>
                                        </div>
                                        <div _ngcontent-hbb-c133="" class="col-12 col-sm-12 col-md-6 mb-1" style="padding-right: 33px !important;
                                                padding-left: 22px !important;">
                                            <label _ngcontent-hbb-c133=""><i _ngcontent-hbb-c133=""
                                                    class="fas fa-id-card"></i> ไอดีไลน์</label>
                                            <input _ngcontent-hbb-c133="" type="text" id="idline" name="idline"
                                                placeholder="เช็คสถานะบัญชีก่อน"
                                                class="form-control ng-untouched ng-pristine ng-valid" disabled>
                                        </div>
                                    </div>
                            ...
                            <div class="row col-sm-12">
                                <div class="col">
                                    <a class="btn btn-danger btn-block" style="color: white;"
                                        href="register"><span>กลับหน้าก่อน</span></a>
                                </div>

                                <div class="col">
                                    <button class="btn btn-success btn-block" id="btn_register" onclick="register()"
                                        style="color: white;" disabled><span>เช็คสถานะบัญชีก่อน</span></ิ>
                                </div>
                            </div>
                        </div>
                    </section>
        ...
        <footer _ngcontent-dhq-c187="" class="page-footer font-small">
            <div _ngcontent-dhq-c187="" class="footer-copyright py-2 text-center">
                <span>&copy; 2021 - <?= date("Y"); ?> | <a href="#"><?= $webname ?></a></span>
            </div>
    ...
    (function() {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/6103dc53d6e7610a49adbd6c/1fbrh9ae7';
        s1.charset = 'UTF-8';
