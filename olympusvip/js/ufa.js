...
function get_name() {
    ...
    if (bank_name != 'truewallet') {
        ...
        document.getElementById("notice_truewallet").innerHTML = 'หากชื่อ-นามสกุลไม่ตรง ไม่สามารถทำการฝากถอนได้';
        document.getElementById("notice_truewallet").style.color = 'red';
        $('#get_bank').modal('hide');
        $('#register_Modal').modal('show');
        $('body').loadingModal('hide');
        $('body').loadingModal('destroy');
