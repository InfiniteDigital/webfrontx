									...
									<div class="x-pending ">
											...
											<div class="row">
												...
												<div class="col d-flex flex-column animated fadeInModal" data-animatable="fadeInModal">
													...
													<div class="-deposit-preview text-center">
														...
														<!-- <div class="my-3">
															<button type="button" id="copyaccnum1" class="btn btn-primary -submit text-center copy-account-number" onclick="Swal.fire({ icon: 'success',title: 'สำเร็จ',text: 'คัดลอกเลขบัญชีแล้ว ' + bank_number22})">
																คัดลอกเลขบัญชี
															</button>
														</div> -->
														<div class="x-admin-contact ">
										...
										<div class="d-lg-none d-block h-100">
											<div class="col d-flex flex-column h-100 px-0">
												...
												<div>
													<!-- <button type="button" id="copyaccnum2" class="btn btn-block -submit btn-primary text-center m-auto js-user-confirm-deposit f-5 copy-account-number" onclick="Swal.fire({ icon: 'success',title: 'สำเร็จ',text: 'คัดลอกเลขบัญชีแล้ว ' + bank_number22})">
														คัดลอกเลขบัญชี
													</button> -->
												</div>
											</div>
