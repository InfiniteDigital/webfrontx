<link rel="stylesheet" href="//s3auto.sgp1.cdn.digitaloceanspaces.com/js_wauto/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
<link rel="stylesheet" href="//s3auto.sgp1.cdn.digitaloceanspaces.com/js_wauto/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
<style>
	.close {
		color: red;
		font-size: 3rem;
...
<app-root _nghost-asb-c187="" ng-version="9.1.13">
						...
						<div _ngcontent-asb-c187="" class="d-flex flex-row justify-content-between align-items-center">
									...
									<div _ngcontent-tdf-c192="" class="d-flex flex-row justify-content-between align-items-center">
										...
										<div _ngcontent-tdf-c192="" class="dropdown pc-view ml-1">
											...
											<div _ngcontent-tdf-c192="" aria-labelledby="menu-profile" id="menu-profile-dropdown" class="dropdown-menu">
												...
												<a _ngcontent-tdf-c192="" href="#" data-toggle="modal" data-target="#modal-userinfo" class="dropdown-item"><i _ngcontent-tdf-c192="" class="fas fa-money-check"></i> บัญชีธนาคาร </a>
												<a _ngcontent-tdf-c192="" href="#" data-toggle="modal" data-target="#partnerProfit" class="dropdown-item" onclick="partnerProfit()"><i _ngcontent-tdf-c192="" class="fas fa-info-circle"></i> ผลประโยชน์หุ้นส่วน </a>
												<a _ngcontent-tdf-c192="" href="#" data-toggle="modal" data-target="#Contactbox" class="dropdown-item"><i _ngcontent-tdf-c192="" class="fas fa-handshake"></i>
													ศูนย์ช่วยเหลือ </a>
							...
							<div _ngcontent-asb-c187="" class="dropdown pc-view ml-1">
								...
								<div _ngcontent-asb-c187="" aria-labelledby="menu-profile" id="menu-profile-dropdown" class="dropdown-menu">
									...
									<a _ngcontent-asb-c187="" href="#" data-toggle="modal" data-target="#modal-coupon" class="dropdown-item"><i _ngcontent-asb-c187="" class="far fa-clipboard"></i>
										กรอกโค๊ด Promotion </a>
									<a _ngcontent-asb-c187="" href="#" data-toggle="modal" data-target="#modal-userinfo" class="dropdown-item"><i _ngcontent-asb-c187="" class="fas fa-money-check"></i> บัญชีธนาคาร </a>
									<a _ngcontent-asb-c187="" href="#" data-toggle="modal" data-target="#partnerProfit" onclick="partnerProfit()" class="dropdown-item"><i _ngcontent-asb-c187="" class="fas fa-info-circle"></i> ผลประโยชน์หุ้นส่วน </a>
									<a _ngcontent-asb-c187="" href="#" data-toggle="modal" data-target="#Contactbox" class="dropdown-item"><i _ngcontent-asb-c187="" class="fas fa-handshake"></i> ศูนย์ช่วยเหลือ </a>
				...
				<div _ngcontent-gca-c154="" class="text-theme-primary rounded p-2 px-3 xtarget col-lotto ng-star-inserted pc-view ">
					...
					<div _ngcontent-gca-c154="" class="row">
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4">
							<div _ngcontent-gca-c154="" class="rounded">
								<a _ngcontent-gca-c154="" target="_blank" href="game">
						...
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4">
							<div _ngcontent-gca-c154="" class="rounded">
								<a _ngcontent-gca-c154="" href="#" onclick="LoginLottoNew()">
									<img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/asssets/yeekee.png" cursorshover="true">
								</a>
							</div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4">
							<div _ngcontent-gca-c154="" class="rounded">
								<a _ngcontent-gca-c154="" target="_blank" href="game">
									<img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/asssets/casino.png" cursorshover="true">
								</a>
							</div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4">
							<div _ngcontent-gca-c154="" class="rounded">
								<a _ngcontent-gca-c154="" href="javascript:void(0)" onclick="LoginLottoNew()">
									<img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/asssets/lotto.png" cursorshover="true">
								</a>
							</div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4">
							<div _ngcontent-gca-c154="" class="rounded">
								<a _ngcontent-gca-c154="" href="javascript:void(0)" onclick="openModalPromotion()">
									<img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/asssets/promotion.png" cursorshover="true">
								</a>
							</div>
						</div>
					...
					<div _ngcontent-gca-c154="" class="" style="padding: 10px;">
						<div _ngcontent-gca-c154="" class="row" style="padding: 10px; color: white !important; font-size: 20px;">
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 mb-2" style="position: relative;" onclick="LoginLottoHistory()">
									<a href="#" class=""><img src="<?= $theme_asset ?>/asssets/icon/icon1.png" style="width: 100%; height: auto;">
										<span class="text-menu">โพยหวย</span> </a>
								</div>
							</div>
							<div class="col-4 col-sm-4 col-md-3 col-lg-2" onclick="getLottoNumberGroup()">
								<div class="text-center px-2 mb-2" style="position: relative;">
									<a href="#" data-toggle="modal" data-target="#number_lotto" class="">
										...
										<span class="text-menu">สร้างเลขชุด</span> </a>
								</div>
							</div>
							<div class="col-3 col-sm-3 col-md-3 col-lg-2" onclick="LoginLottoAwards()">
								<div class="text-center px-2 mb-2" style="position: relative;"><a href="#" class="">
										<img src="<?= $theme_asset ?>/asssets/icon/icon3.png" style="width: 100%; height: auto;">
										<span class="text-menu">ผลรางวัล</span> </a></div>
							</div>
							...
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 mb-2" style="position: relative;"><a href="#" data-toggle="modal" data-target="#vip_group" class=""><img src="<?= $theme_asset ?>/asssets/icon/icon7.png" style="width: 100%; height: auto;">
										<span class="text-menu">กลุ่มเลขเด็ด</span> </a></div>
							</div>
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
	...
	<div class="x-modal modal" id="modal-promotion_register" tabindex="-1" role="dialog" aria-hidden="true" data-loading-container=".js-modal-content" data-ajax-modal-always-reload="true">
		<div class="modal-dialog modal-dialog modal-lg" role="document">
			<div class="modal-content -modal-content" style="background-color: #1a283c;">
				<img src="build/web/ufacoder/img/border-modal.png" class="img-fluid d-lg-block -border-top-modal" alt="">
				<button type="button" class="close f-1" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">×</span>
				</button>
				<div data-animatable="fadeInModal" data-offset="0" class="-animatable-container animated fadeInModal">
										...
										<table class="table text-white">
											<thead>
												<tr class="text-center">
													...
													<th class="table-profit" rowspan="2">สมัครทั้งหมด</th>
											...
											<tbody id="partner-profit">
												<tr>
													<th class="text-center table-profit" style="color:#fff">1</th>
													<th class="text-center table-profit" style="color:#fff">1</th>
													<th class="text-center table-profit" style="color:#fff">1</th>
												</tr>
											</tbody>
			...
			<div _ngcontent-asb-c187="" class="modal-content" style="border-radius: 10px;">
				...
				<div _ngcontent-asb-c187="" class="modal-body" style="top: 15px;">
					...
					<div _ngcontent-asb-c187="" class="modal-footer">
						<button _ngcontent-asb-c187="" type="button" onclick="coupon_voucher(<?= $info['id'] ?>)" class="btn btn-theme-primary" style="width: -webkit-fill-available; box-shadow: -1px 2px 5px black;">ยืนยัน</button>
					</div>
				</div>
			</div>
		</div>
...
<script src="//s3auto.sgp1.cdn.digitaloceanspaces.com/js_wauto/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="//s3auto.sgp1.cdn.digitaloceanspaces.com/js_wauto/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js"></script>
<script src="//s3auto.sgp1.cdn.digitaloceanspaces.com/js_wauto/plugins/datatables-responsive/js/dataTables.responsive.min.js"></script>
<script src="//s3auto.sgp1.cdn.digitaloceanspaces.com/js_wauto/plugins/datatables-responsive/js/responsive.bootstrap4.min.js"></script>
		...
		function onChangeSelectPromotion() {
			...
			if (id == 0) {
				...
				$.ajax({
					...
					success: function(result) {
						htm = `<h4>รายละเอียดโปรโมชั่น-3</h4>
                                <img src="${result.pro_detail[0].img_name}" class="img-fluid" alt="">
                                <br>`;
						if (!result.status) {
		...
		function onChangeSelectPromotion1() {
			...
			if (id == 0) {
				...
				$.ajax({
					...
					success: function(result) {
						htm = `<h4>รายละเอียดโปรโมชั่น-4</h4>
                                <img src="${result.pro_detail[0].img_name}" class="img-fluid" alt="">
                                <br>`;
						if (!result.status) {
							htm += `<h2 class="text-center" style="color:red;">${result.msg}</h2>`;
