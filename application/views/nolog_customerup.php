<app-root _nghost-nbo-c179="" ng-version="9.1.13">
	<div _ngcontent-nbo-c179="" id="app pc-view" style="min-height: calc(100% - 60px); overflow: hidden;">
					...
					<div _ngcontent-nbo-c179="" class="container">
						<div _ngcontent-nbo-c179="" class="row py-2 text-light">
							...
							<div _ngcontent-nbo-c179="" class="col-6 col-sm-6 col-md-4 col-lg-2 my-2 d-flex order-0 order-md-0">
								<a _ngcontent-nbo-c179="" href="register" type="button" class="btn  btn-block btn-register"><i class="fa-solid fa-user"></i>
									สมัครสมาชิก</a>
							</div>
							<div _ngcontent-nbo-c179="" class="col-md-4 col-lg-2 my-2 col-12 order-1 order-md-0">
								<a _ngcontent-nbo-c179="" target="_blank" href="https://line.me/R/ti/p/<?= $line_admin ?>" class="btn btn-block btn-register-with-ad" cursorshover="true">
									<i _ngcontent-nbo-c179="" class="fa fa-user-plus"></i> สมัครผ่านแอดมิน
								</a>
							</div>
							<div _ngcontent-nbo-c179="" class="col-6 col-sm-6 col-md-4 col-lg-2 my-2 d-flex order-0 order-md-0">
								<a _ngcontent-nbo-c179="" href="#" type="button" class="btn  btn-block btn-forgetpass" cursorshover="true">
		...
		<div _ngcontent-nbo-c179="" class="banner-colosal ng-star-inserted pc-view">
