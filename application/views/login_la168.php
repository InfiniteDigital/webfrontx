...
<app-root _nghost-asb-c187="" ng-version="9.1.13">
						...
						<div _ngcontent-asb-c187="" class="d-flex flex-row justify-content-between align-items-center">
									...
									<div _ngcontent-tdf-c192="" class="d-flex flex-row justify-content-between align-items-center">
										...
										<div _ngcontent-tdf-c192="" class="dropdown pc-view ml-1">
											...
											<div _ngcontent-tdf-c192="" aria-labelledby="menu-profile" id="menu-profile-dropdown" class="dropdown-menu">
												<a _ngcontent-tdf-c192="" href="#" data-toggle="modal" data-target="#modal-userinfo" class="dropdown-item">
													<i _ngcontent-tdf-c192="" class="fas fa-user-cog"></i>
							...
							<div _ngcontent-asb-c187="" class="dropdown pc-view ml-1">
								...
								<div _ngcontent-asb-c187="" aria-labelledby="menu-profile" id="menu-profile-dropdown" class="dropdown-menu">
									...
									<a _ngcontent-asb-c187="" href="#" data-toggle="modal" data-target="#partnerProfit" class="dropdown-item" onclick="partnerProfit()"><i _ngcontent-asb-c187="" class="fas fa-info-circle"></i> ผลประโยชน์หุ้นส่วน </a>
			...
			<div id="section-content" class="container">
				<div class="row justify-content-center pc-view">
					<div class="col-5 mb-2">
						<div class="d-flex flex-column justify-content-between shadow px-3 py-3 my-3 mx-0" style="background: url('<?= $theme_asset ?>/asssets/bg-money.png') center center / contain no-repeat;">
				...
				<div _ngcontent-vsx-c14="" class="mobile-view mb-5" style="margin-top: -25px;">
					<div class="col-4" style="margin-top: 11px !important; margin-right: 10px !important;">
						...
						<div>
							...
							<!--แจ้งเครดิต-->
							<div class="col-lg-4 col-6">
								<a href="https://line.me/R/ti/p/<?= $line ?>" class="btn btn-block rounded btn-contact-main bg-galaxy" style="    background: linear-gradient(180deg, rgba(191,27,219,1) 0%, rgba(222,0,250,1) 46%, rgba(125,0,213,1) 100%);border: #8f03ab 4px solid;box-shadow: 0px 0px 5px 5px #e200ff7d;width: 7rem; height: 80px; margin-left: -15px; margin-bottom: 8px">
									<div>
				...
				<div _ngcontent-gca-c154="" class="text-theme-primary rounded p-2 px-3 xtarget col-lotto ng-star-inserted pc-view ">
					...
					<div _ngcontent-gca-c154="" class="row">
						...
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4">
							<div _ngcontent-gca-c154="" class="rounded">
								<a _ngcontent-gca-c154="" href="javascript:void(0)" data-toggle="modal" data-target="#modal-promotion_register">
	...
	<footer _ngcontent-asb-c187="" class="page-footer font-small">
		<div _ngcontent-dhq-c187="" class="footer-copyright py-2 text-center pc-view">
			<span>&copy; 2021 - <?= date("Y"); ?> | <a href="#">dddo.page</a></span>
		</div>
...
<script>
	...
	<?php if ($user) : ?>
		let url_backend = 'https://api.dddo.page';
									...
									$.ajax({
										...
										success: function(data) {
											...
											if (data.result.statusCodeText == '200') {
												window.location.href = 'https://lotto.dddo.page/pages/main/index.html?token=' + data.result.token;
											}
										}
									})
								}
							...
							$.ajax({
								...
								success: function(data) {
									...
									$.ajax({
										...
										success: function(data) {
											if (data.result.statusCodeText == '200') {
												window.location.href = 'https://lotto.dddo.page/pages/awards/index.html?token=' + data.result.token;
											}
										}
									})
								}
							...
							$.ajax({
								...
								success: function(data) {
									...
									$.ajax({
										...
										success: function(data) {
											if (data.result.statusCodeText == '200') {
												window.location.href = 'https://lotto.dddo.page/pages/history/index.html?token=' + data.result.token;
											}
										}
									})
								}
		...
		function checkCreditLotto111() {
			$.ajax({
				...
				success: function(data) {
					let tokenUser = data.token;
					$.ajax({
						url: url_backend + '/checkCreditLotto',
						method: 'post',
						headers: {
							"Authorization": "Bearer " + tokenUser
						},
