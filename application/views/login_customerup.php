										...
										<nav _ngcontent-tso-c195="" id="sidebar" style="display: none;" class="active">
											...
											<ul _ngcontent-tso-c195="" class="list-unstyled components">
												...
												<li _ngcontent-tso-c195=""><a _ngcontent-tso-c195="" href="#/setting-bank" routerlink="/setting-bank"><i _ngcontent-tso-c195="" class="fas fa-money-check"></i>
														บัญชีธนาคาร</a></li>
												<li _ngcontent-tso-c195=""><a _ngcontent-tso-c195="" href="/doc"><i _ngcontent-tso-c195="" class="fas fa-info-circle"></i> วิธีใช้งาน</a></li>
										...
										<div _ngcontent-tdf-c192="" class="dropdown pc-view ml-1">
											...
											<div _ngcontent-tdf-c192="" aria-labelledby="menu-profile" id="menu-profile-dropdown" class="dropdown-menu">
												<a _ngcontent-tdf-c192="" href="#" data-toggle="modal" data-target="#modal-userinfo" class="dropdown-item"><i _ngcontent-tdf-c192="" class="fas fa-user-cog"></i>
													ตั้งค่าบัญชีผู้ใช้ </a><a _ngcontent-tdf-c192="" href="#" data-toggle="modal" data-target="#modal-userinfo" class="dropdown-item"><i _ngcontent-tdf-c192="" class="fas fa-money-check"></i> บัญชีธนาคาร </a><a _ngcontent-tdf-c192="" href="doc" class="dropdown-item"><i _ngcontent-tdf-c192="" class="fas fa-info-circle"></i> วิธีใช้งาน </a><a _ngcontent-tdf-c192="" href="#" data-toggle="modal" data-target="#Contactbox" class="dropdown-item"><i _ngcontent-tdf-c192="" class="fas fa-handshake"></i>
													ศูนย์ช่วยเหลือ </a>
		...
		<app-main _nghost-asb-c14="" class="ng-star-inserted">
			...
			<div class="row pc-view">
					<div class="col-12 mb-2">
						<div class="d-flex flex-column card-main justify-content-between shadow px-3 py-3 my-3 mx-0 card-main-top-menu">
							<div class="d-flex justify-content-between">
								<div class="d-flex justify-content-start">
									<h3 class="mx-2 px-2">USER ID : <?= $user ?></h3>
								</div>
								<div class="d-flex justify-content-end">
									<h4 class="remain-credit-title py-2 px-2 text-center">ยอดเงินคงเหลือ</h4>
								</div>
							</div>
						...
						<div class="row text-center">
							...
							<div class="col-4">
								<a href="javascript:void(0)" data-toggle="modal" data-target="#Deposit">
									<div class="btn btn-block rounded" style="background: linear-gradient(90deg, rgba(188,142,47,1) 0%, rgba(244,225,133,1) 50%, rgba(183,135,46,1) 100%);color:#6f4900;border: #a67c00 3px solid;">
										<div>
							...
							<div class="col-4">
								<a href="javascript:void(0)" data-toggle="modal" data-target="#Withdraw">
									<div class="btn btn-block rounded" style="background: linear-gradient(90deg, rgba(190,190,190,1) 0%, rgba(214,214,214,1) 50%, rgba(161,161,161,1) 100%);color:#6f4900;border:#898989 3px solid;">
										<div>
							...
							<div class="col-4">
								<a href="https://line.me/R/ti/p/<?= $line ?>">
									<div class="btn btn-block rounded" style="background: linear-gradient(90deg, rgba(38,38,38,1) 0%, rgba(79,79,79,1) 50%, rgba(0,0,0,1) 100%);border:#e7a52e 3px solid;">
					...
					<div class="col-12 my-2">
						<a href="javascript:void(0)" class="btn btn-block btn-move-main p-3 game-to-wallet" style="background: linear-gradient(90deg, rgba(188,142,47,1) 0%, rgba(244,225,133,1) 50%, rgba(183,135,46,1) 100%);color:#6f4900;border: #a67c00 3px solid;font-size: 1.2rem;">
				...
				<div _ngcontent-vsx-c14="" class="mobile-view mb-5" style="margin-top: -25px;">
					<div class="col-4" style="margin-top: 11px !important; margin-right: 10px !important;">
						...
						<div>
							<div class="col-lg-4 col-6">
								<a href="javascript:void(0)" data-toggle="modal" data-target="#Deposit" class="btn btn-block rounded btn-deposit-main" style="background: linear-gradient(90deg, rgba(188,142,47,1) 0%, rgba(244,225,133,1) 50%, rgba(183,135,46,1) 100%);color: #6f4900;border: #a67c00 3px solid;width: 7rem; height: 80px; margin-left: -15px; margin-bottom: 8px">
									<div>
							...
							<!--ถอนเงิน โมบาย-->
							<div class="col-lg-4 col-6">
								<a href="javascript:void(0)" data-toggle="modal" data-target="#Withdraw" class="btn btn-block rounded btn-withdraw-main" style="background: linear-gradient(90deg, rgba(190,190,190,1) 0%, rgba(214,214,214,1) 50%, rgba(161,161,161,1) 100%);color: #6f4900;border: #898989 3px solid;width: 7rem; height: 80px; margin-left: -15px; margin-bottom: 8px">
									<div>
										<i class="fas fa-building" style="font-size: 1.4rem;"></i>
							...
							<!--แจ้งเครดิต-->
							<div class="col-lg-4 col-6">
								<a href="https://line.me/R/ti/p/<?= $line ?>" class="btn btn-block rounded btn-contact-main" style="background: linear-gradient(90deg, rgba(38,38,38,1) 0%, rgba(79,79,79,1) 50%, rgba(0,0,0,1) 100%);border: #e7a52e 3px solid;width: 7rem; height: 80px; margin-left: -15px; margin-bottom: 8px">
									<div style="background: -webkit-linear-gradient(#f5c265, #f7f3de);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
										<i class="fas fa-building" style="font-size: 1.4rem;"></i>
					...
					<div class="col-8">
						<div class="d-flex flex-column card-main justify-content-between shadow px-3 py-3 my-3 mx-0 card-main-top-menu">
							<div class="d-flex justify-content-between"><span class="remain-credit-title">ยอดเงินคงเหลือ</span>
							</div>
						...
						<div style="margin-top: 125px !important;">
							<div class="d-flex flex-column justify-content-between shadow px-2 py-2 my-2 mx-0 btn btn-block btn-move-main" style="background: linear-gradient(90deg, rgba(188,142,47,1) 0%, rgba(244,225,133,1) 50%, rgba(183,135,46,1) 100%);color: #6f4900;border: #a67c00 3px solid;margin-top: -115px !important;    padding: 10px !important;">
								<div class="d-flex flex-row justify-content-between mt-1 ">
									<div class="d-flex flex-column pt-0 pb-1 ">
				...
				<div _ngcontent-asb-c14="" class="row p-0 m-1  mobile-view" style="
					...
					<div _ngcontent-gca-c154="" class="d-flex justify-content-center">
						<img _ngcontent-gca-c154="" src="<?= $theme_asset ?>/asssets/mainmenu.png" class="header">
					</div>
					<div _ngcontent-gca-c154="" class="row boxgame boxgame-slot">
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" target="_blank" href="game"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/asssets/sports.png" cursorshover="true"></a></div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" href="#"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/asssets/minigame.png" cursorshover="true"></a></div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" href="javascript:void(0)" onclick="LoginLottoNew()"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/asssets/yeekee.png" cursorshover="true"></a></div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" target="_blank" href="game"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/asssets/casino.png" cursorshover="true"></a></div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" href="javascript:void(0)" onclick="LoginLottoNew()"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/asssets/lotto.png" cursorshover="true"></a></div>
						</div>
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" href="#" data-toggle="modal" data-target="#modal-promotion_register"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/asssets/promotion.png" cursorshover="true"></a></div>
						</div>
				...
				<div _ngcontent-gca-c154="" class="text-theme-primary rounded p-2 px-3 xtarget col-lotto ng-star-inserted pc-view ">
					...
					<div _ngcontent-gca-c154="" class="row boxgame boxgame-slot">
						...
						<div _ngcontent-gca-c154="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2 ng-star-inserted">
							<div _ngcontent-gca-c154="" class="rounded"><a _ngcontent-gca-c154="" href="javascript:void(0)" data-toggle="modal" data-target="#modal-promotion_register"><img _ngcontent-gca-c154="" class="img-game" src="<?= $theme_asset ?>/asssets/promotion.png" cursorshover="true"></a></div>
						</div>
				...
				<div _ngcontent-gca-c154="" class="text-theme-primary rounded p-2 px-3 xtarget col-lotto ng-star-inserted pc-view ">
					...
					<div _ngcontent-gca-c154="" class="boxgame boxgame-slot" style="padding: 10px;">
						<div _ngcontent-gca-c154="" class="row" style="padding: 10px; color: white !important; font-size: 20px;">
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 " style="position: relative;" onclick="LoginLottoHistory()">
									<a href="#" class=""><img src="<?= $theme_asset ?>/asssets/icon/icon1.png" style="width: 100%; height: auto;">
										โพยหวย </a>
								</div>
							</div>
							<div class="col-4 col-sm-4 col-md-3 col-lg-2" onclick="getLottoNumberGroup()">
								<div class="text-center px-2 " style="position: relative;">
									<a href="#" data-toggle="modal" data-target="#number_lotto" class="">
										<img src="<?= $theme_asset ?>/asssets/icon/icon2.png" style="width: 100%; height: auto;">
										สร้างเลขชุด </a>
								</div>
							</div>
							<div class="col-3 col-sm-3 col-md-3 col-lg-2" onclick="LoginLottoAwards()">
								<div class="text-center px-2 " style="position: relative;"><a href="#" class="">
										<img src="<?= $theme_asset ?>/asssets/icon/icon3.png" style="width: 100%; height: auto;">
										ผลรางวัล </a></div>
							</div>
							<div class="col-3 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 " style="position: relative;">
									<a href="#/poy" routerlink="/poy" class="">
										<img src="<?= $theme_asset ?>/asssets/icon/icon4.png" style="width: 100%; height: auto;">
										แชทสด </a>
								</div>
							</div>
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 " style="position: relative;">
									<a href="#/poy" routerlink="/poy" class="">
										<img src="<?= $theme_asset ?>/asssets/icon/icon5.png" style="width: 100%; height: auto;">
										ติดตั้งแอป </a>
								</div>
							</div>
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 " style="position: relative;"><a href="#" data-toggle="modal" data-target="#refFriendModal" class=""><img src="<?= $theme_asset ?>/asssets/icon/icon6.png" style="width: 100%; height: auto;">
										แนะนำเพื่อน </a></div>
							</div>
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 " style="position: relative;"><a href="#" data-toggle="modal" data-target="#vip_group" class=""><img src="<?= $theme_asset ?>/asssets/icon/icon7.png" style="width: 100%; height: auto;">
										กลุ่มเลขเด็ด </a></div>
							</div>
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 " style="position: relative;"><a href="/doc" class=""><img src="<?= $theme_asset ?>/asssets/icon/icon8.png" style="width: 100%; height: auto;">
										วิดีโอการใช้งาน </a></div>
							</div>
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 " style="position: relative;">
							...
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 " style="position: relative;"><a href="#" id="wheelspinufa" class=""><img src="<?= $theme_asset ?>/asssets/icon/icon10.png" style="width: 100%; height: auto;">
										วงล้อนำโชค </a></div>
							</div>
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 " style="position: relative;"><a href="#" onclick="openModalWinloss();" class=""><img src="<?= $theme_asset ?>/asssets/icon/icon11.png" style="width: 100%; height: auto;">
										คืนยอดเสีย </a></div>
							</div>
							<div class="col-4 col-sm-4 col-md-3 col-lg-2">
								<div class="text-center px-2 " style="position: relative;">
									<a href="#" data-toggle="modal" data-target="#modal-promotion_register"><img src="<?= $theme_asset ?>/asssets/icon/icon12.png" style="width: 100%; height: auto;">
										โปรโมชั่น </a>
								</div>
							</div>
						</div>
						<div _ngcontent-gca-c154="" class="d-flex justify-content-center">
							<div _ngcontent-ont-c14="" class="col-6 col-md-4 col-lg-4 col-xl-4 p-2">
								<a href="#" data-toggle="modal" data-target="#modal-transection">
									<div _ngcontent-gca-c154="" class="text-center px-2 " style="position: relative;">
										<img src="<?= $theme_asset ?>/asssets/แจ้งรายงสย.png">
									</div>
								</a>
							</div>
						</div>
				...
				<div _ngcontent-asb-c14="" class="row py-3 px-2 mx-1  mobile-view" style="
					...
					<div _ngcontent-gca-c154="" class="boxgame boxgame-slot" style="padding: 10px;">
						<div _ngcontent-gca-c154="" class="row " style="padding: 10px;">
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1" onclick="LoginLottoHistory()">
								<div _ngcontent-ont-c14="" class="text-center px-2" style="position: relative; margin-bottom: 15px;"><a _ngcontent-ont-c14="" href="#" class="btn-main-menu-mobile"><img _ngcontent-ont-c14="" src="<?= $theme_asset ?>/asssets/icon/icon1.png" style="width: 100%; height: auto;">
										โพยหวย </a>
								</div>
							</div>
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1">
								<div _ngcontent-ont-c14="" class="text-center px-2" style="position: relative;margin-bottom: 15px;"><a _ngcontent-ont-c14="" href="#" class="btn-main-menu-mobile"><img _ngcontent-ont-c14="" src="<?= $theme_asset ?>/asssets/icon/icon4.png" style="width: 100%; height: auto;">
										แชทสด
									</a></div>
							</div>
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1">
								<div _ngcontent-ont-c14="" class="text-center px-2" style="position: relative;margin-bottom: 15px;"><a _ngcontent-ont-c14="" href="#" data-toggle="modal" data-target="#number_lotto" class="btn-main-menu-mobile"><img _ngcontent-ont-c14="" src="<?= $theme_asset ?>/asssets/icon/icon2.png" style="width: 100%; height: auto;">
										สร้างเลขชุด </a></div>
							</div>
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1">
								<div _ngcontent-ont-c14="" class="text-center px-2" style="position: relative;margin-bottom: 15px;"><a _ngcontent-ont-c14="" href="javascript:void(0);" class="btn-main-menu-mobile"><img _ngcontent-ont-c14="" src="<?= $theme_asset ?>/asssets/icon/icon5.png" style="width: 100%; height: auto;">
										ติดตั้งแอปฯ
									</a></div>
							</div>
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1">
							...
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1">
								<div _ngcontent-ont-c14="" class="text-center px-2" style="position: relative;margin-bottom: 15px;"><a _ngcontent-ont-c14="" href="javascript:void(0);" data-toggle="modal" data-target="#vip_group" class="btn-main-menu-mobile"><img _ngcontent-ont-c14="" src="<?= $theme_asset ?>/asssets/icon/icon7.png" style="width: 100%; height: auto;">
										กลุ่มเลขเด็ด </a></div>
							</div>
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1" onclick="LoginLottoAwards()">
								<div _ngcontent-ont-c14="" class="text-center px-2" style="position: relative;margin-bottom: 15px;">
									<a _ngcontent-ont-c14="" href="#/result-all" routerlink="/result-all" class="btn-main-menu-mobile">
										<img _ngcontent-ont-c14="" src="<?= $theme_asset ?>/asssets/icon/icon3.png" style="width: 100%; height: auto;">
										ผลรางวัล
									</a>
								</div>
							</div>
							...
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1">
								<div _ngcontent-ont-c14="" class="text-center px-2" style="position: relative;margin-bottom: 15px;">
									<a _ngcontent-ont-c14="" href="javascript:void(0);" data-toggle="modal" data-target="#modal-promotion_register" class="btn-main-menu-mobile"><img _ngcontent-ont-c14="" src="<?= $theme_asset ?>/asssets/icon/icon12.png" style="width: 100%; height: auto;">
										โปรโมชั่น </a>
								</div>
							</div>
							<div _ngcontent-ont-c14="" class="col-4 mx-0 px-1">
							...
							$.ajax({
								...
								success: function(data) {
									...
									$.ajax({
										...
										success: function(data) {
											if (data.result.statusCodeText == '200') {
												window.location.href = 'https://lotto.huaydet789.com/pages/awards/index.html?token=' + data.result.token;
											}
										}
									})
								}
							...
							$.ajax({
								...
								success: function(data) {
									...
									$.ajax({
										...
										success: function(data) {
											if (data.result.statusCodeText == '200') {
												window.location.href = 'https://lotto.huaydet789.com/pages/history/index.html?token=' + data.result.token;
											}
										}
									})
								}
